Supervisor-AI --- כלי לבדיקת אתרי בנייה המבוסס על בינה מלאכותית ומיועד למפקחי בנייה בישראל

תיאור:
Supervisor AI – בקרת איכות וויזואלית לאתרי בנייה במודל מקומי המתאימה מצויין ליומן עבודה: כלי לבדיקת אתרי בנייה המבוסס על בינה מלאכותית ומיועד למפקחי בנייה בישראל. המערכת מנצלת מודל חזותי-שפתי (VLM) המארח באופן מקומי ורץ על מעבדי Apple Silicon (מחשבי Mac Mini) דרך Ollama, כדי לספק בזמן אמת דוחות בטיחות ובקרת איכות (QA) נימוסיים, מעשיים ובעברית.
...
<img width="1012" height="547" alt="image" src="https://github.com/user-attachments/assets/d58573a6-4ea6-43af-a5f0-b467335eb08e" />
